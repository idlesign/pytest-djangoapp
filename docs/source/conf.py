# -*- coding: utf-8 -*-
#
# pytest-djangoapp documentation build configuration file.
#
...
copyright = u'2018-2023, Igor `idle sign` Starikov'
...
htmlhelp_basename = 'pytest-djangoappdoc'
...
latex_documents = [
  ('index', 'pytest-djangoapp.tex', u'pytest-djangoapp Documentation',
...
man_pages = [
    ('index', 'pytest-djangoapp', u'pytest-djangoapp Documentation',
